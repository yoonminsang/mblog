module.exports = {
  ...
  allPostList: function(post) {
    ...
    for (var i = 0; i < post.length; i++) {
      var cont = post[i].content.replace(/(<([^>]+)>)/gi, "");
      var content = cont.replace(/&nbsp;/g, " ").substring(0, 400);
      list += `
      <div class="post-item">
        <a href="../../${post[i].category_id}/post/${post[i].id}">
          <span class="img"></span>
      ...
      <body>
        ...
        <aside>
          <div id="manage_menu">
            ...
            <strong><img src="/static/images/comment.png" alt="댓글·방명록" />
              <span>댓글·방명록</span>
            </strong>
            <ul class="manage_menu_ul">
              <li class="manage_menu_li"><a href="/manage/comments">댓글 관리</a></li>
              <li class="manage_menu_li"><a href="/manage/guestbook">방명록 관리</a></li>
            </ul>
            <strong>
            ...
            <ul class="manage_menu_ul">
              <li class="manage_menu_li"><a href="/manage/visit">방문 통계</a></li>
              <li class="manage_menu_li"><a href="/manage/referrer">유입 경로</a></li>
            </ul>
          </div>
        </aside>
        <hr />
